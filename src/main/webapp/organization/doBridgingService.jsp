...
<title>Presenting service in tree form</title>
    ...
    <center>
        ...
        <div class="main-navigation">
             <div id="menu_grid" style="width:180px; height:210px" class='glossymenu <%=session.getAttribute("userType")%>'>
             <script>
            ...
            <div class="main-content" style="width:550px;">
                <br>
                <p><h2>Do Bridging</h2>
                <p class="info_message">In this page you can use your bridging services.</br>
                   Fill the form or load an input xml. 
                </p>
                <form method="post" name="do_bridge" action="./OrganizationManager?op=doBridgingService&cpa_id=<%=request.getParameter("cpa_id")%>" enctype="multipart/form-data" onSubmit="update_serviceInputArgs();">
             <table><tbody>
               <%
               if (session.getAttribute("serviceInputArgs") != "") {
