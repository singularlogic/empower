    ...
    <center>
        ...
        <div class="main">
            ...
            <div class="main-content" style="width:550px;">
                ...
                <div id="sourcee_xml" style="float:left;width:260px;margin-right:23px;height:300px;background-color:#f5f5f5;border :1px solid Silver;; overflow:auto;"/>
                <p><h2>Source XML</h2>
                <script>
            ...
            <div id="target_xml" style="float:left;width:260px; height:300px;background-color:#f5f5f5;border :1px solid Silver;; overflow:auto;"/>
            <p><h2>Target XML</h2>
            <script>
