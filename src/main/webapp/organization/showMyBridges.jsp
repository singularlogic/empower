    ...
    <head>
        ...
        <script type="text/javascript">                                          
            function doOnRowSelected()
            {
               ...
               //var cell_index= getSelectedCellIndex();        
            }
        </script>
    </head> 
        ...
        <div class="main">
            <div class="main-navigation">
                ...
                <div class='glossymenu'>
                    ...
                    <div class='submenu1'><a class='menuitem' href='showSoftwareComponent.jsp'>Show software components</a></div> 
                    <div class='submenu1'><a class='menuitem' href='showMyBridges.jsp'>Show My Bridges</a></div>                  
                    <div class='submenu1'><a class='menuitem' href='../DIController?op=signout'>Logout</a></div>                   
                </div>
            </div>    
